...
namespace OcupacionkarmeleOntology
{
	[ExcludeFromCodeCoverage]
	public class Occupation : GnossOCBase
	{
		public Occupation(string pIdentificador)
		{
		}

		public Occupation(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
		...
		public virtual string RdfType { get { return "http://schema.org/Occupation"; } }
		public virtual string RdfsLabel { get { return "http://schema.org/Occupation"; } }
		...
		public virtual SecondaryResource ToGnossApiResource(ResourceApi resourceAPI,string identificador)
		{
			...
			GetProperties();
			SecondaryOntology ontology = new SecondaryOntology(resourceAPI.GraphsUrl, resourceAPI.OntologyUrl, "http://schema.org/Occupation", "http://schema.org/Occupation", prefList, propList,identificador,listSecondaryEntity, null);
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://schema.org/Occupation>", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/{Identificador}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://schema.org/Occupation\"", list, " . ");
		...
		{
			return $"{resourceAPI.GraphsUrl}items/OcupacionkarmeleOntology_{ResourceID}_{ArticleID}";
		}
